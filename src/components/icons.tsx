...
export const GitHub = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            fill = "currentColor",
...
export const Obsidian = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
...
export const Moon = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
...
export const Sun = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
...
export const Computer = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
...
export const Home = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
...
export const X = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
...
export const Spinner = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        ...
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
             className={cn("fill-current stroke-current stroke-2 animate-spin w-8 h-8", className)} {...props}>
            <path
...
export const Error = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            ...props
        ...
        <svg
            ...
            {...props}
        >
            <motion.g fillOpacity={0.976} fill="#f27474">
                <motion.path initial={{
                    pathLength: 0,
                    opacity: 0,
                }}
...
export const LockClosed = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            ...props
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
             className={cn("w-6 h-6", className)} ref={ref} {...props}>
...
export const LockOpen = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            ...props
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
             className={cn("w-6 h-6", className)} {...props}>
            <path strokeLinecap="round" strokeLinejoin="round"
...
export const HomeSolid = React.forwardRef<SVGSVGElement, SVGProps>(
    (
        {
            className,
            children,
