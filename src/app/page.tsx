        ...
        <div className={"text-center flex flex-col flex-1 items-center justify-center gap-6"}>
            <div>
                <div className={"flex justify-center gap-4 items-center mb-8"}>
                    ...
                    <p className={"text-4xl font-bold animate-in rotate-[180deg] delay-300 transition-all duration-1000"}>
                        X
                    </p>
                    <Obsidian className={"w-24 h-24"}/>
                </div>
                <h1 className={"text-4xl font-bold"}>GitHub Repository Browser</h1>
                <h2 className={"text-xl leading-[4rem]"}>
                    A simple GitHub repository browser
                </h2>
                <p>
                    This is a simple GitHub repository browser, that allows you to browse
                    through the files and folders of any GitHub repository.
                    <br/>
                    This is a test of the recursive repo browser, which is a recursive
                    implementation of the repo browser.
                </p>
                <p
                    className={
                ...
                >
                    ...
                    <br/>
                    <span className={"font-bold"}>Note:</span> This is a work in progress,
